		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:JYVKdTSA3DCSHO24BgbhTdGEGkXsnfKUfBoCNmaWzCQ=");
...
///////////////////////    			
				...
				try (Connection connection = DriverManager.getConnection(jdbcUrl, username, password);
					...
					Liquibase li = new Liquibase("changelog.xml", new ClassLoaderResourceAccessor(), DatabaseFactory
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/Rami/IdeaProjects/JAVASQLSERVER/src/main/resources/changelog.xml";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/Rami/IdeaProjects/JAVASQLSERVER/src/main/resources/changelog.xml",
...
///////////////////////    			
					...
					if (!((Object) ("C:/Users/Rami/IdeaProjects/JAVASQLSERVER/src/main/resources/changelog.xml") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = simple.class.getClassLoader()
					.getResourceAsStream("local_project/simple_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = simple.class.getClassLoader()
...
/************************************************************************************************
 * 48896 characters generated by Talend Open Studio for Data Integration on the
 * 19 juillet 2023 à 18:44:25 GMT+01:00
 ************************************************************************************************/